...
network/subprocess capability, scenario execution, artifact-schema change or AGENTS.md.
...
AGENTS.md. `git diff --check` passed. Exact-commit CI is the final gate before V2-02.
